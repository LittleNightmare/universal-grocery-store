...
<head>
    ...
    <title>Milk and Eggs</title>
    <link rel="stylesheet" href="css/p2_products.css">
    <link rel="stylesheet" href="css/p2_milk&eggs.css">
...
<body>
    ...
    <div class="banner">
        ...
        <div class="w">
            ...
            <!-- 版心title -->
            <div class="ttl">
                <h2>Everyday Fresh Milk and Eggs</h2>
                <div class="pic"></div>
            </div>
            <!-- special -->
            <div class="special">
    ...
    <div class="box w">
        <div class="box-hd">
            <h3>Milk and Eggs</h3>
            <a href="milkeggs.php">View All</a>
        </div>
        <div class="box-bd">
            <ul class="clearfix">
            <?php include("conn.php");
                    $rs2 = mysqli_query($link, "select * from products where type='MilkEggs' order by id desc limit 0,5");

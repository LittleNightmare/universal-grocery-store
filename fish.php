...
<head>
    ...
    <link rel="stylesheet" href="css/p2_fish.css">
...
<body>
    ...
    <div class="box w">
        <div class="box-hd">
            <h3>Fish</h3>
            <a href="fish.php">View All</a>
        </div>
        <div class="box-bd">
            <ul class="clearfix">
            <?php include("conn.php");
                    $rs2 = mysqli_query($link, "select * from products where type='Fish' order by id desc limit 0,5");

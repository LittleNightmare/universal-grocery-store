  ...
  <nav class="navbar sticky-top navbar-expand-xl bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="back-order.php">Order Management</a>
        </li>
      </ul>
    </div>
  </nav>
        ...
        <div class="table-responsive bg-light rounded shadow-sm">
          <table class="table table-sm table-hover table-bordered">
            ...
            <tbody>
              ...
              <?php
              include("../conn.php");
              $rs2 = mysqli_query($link, "select * from orderlist order by id desc ");
              $i = 1;
              ...
              ?>
                <tr>
                  ...
                  <td><?php if ($row['flag'] == "0") {
                        echo "Not to deliver goods";
                      }; ?><?php if ($row['flag'] == "1") {
                                                                                    echo "Has been shipped";
                                                                                  }; ?><?php if ($row['flag'] == "2") {
                                                                                                                                            echo "Have the goods";
                                                                                                                                          }; ?></td>
                  ...
                  <td><a href="edit-order.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</button></td>
                  <td><a href="delorder.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>

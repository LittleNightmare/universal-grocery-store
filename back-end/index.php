...
<body>
  <nav class="navbar sticky-top navbar-expand-xl bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="index.php">Product Management</a>
        </li>
        <li class="nav-item">
        ...
        <div class="table-responsive bg-light rounded shadow-sm">
          <table class="table table-sm table-hover table-bordered">
            ...
            <tbody>
              ...
              <?php
              include("../conn.php");
              $rs2 = mysqli_query($link, "select * from products order by id desc ");
              $i = 1;
              ...
              ?>
                <tr>
                  ...
                  <td><a href="edit-product.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</button></td>
                  <td><a href="delgood.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
              <?php
                $i++;
              } ?>
